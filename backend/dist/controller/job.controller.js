...
class JobController {
    ...
    getJobs(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { titleOrCategory, city, category, tags, isPublished, page = "1", size = "10", minSalary, maxSalary, worksite, date, sort, } = req.query;
                const parsedTags = typeof tags === "string" ? tags.split(",") : [];
                const worksiteParam = worksite === null || worksite === void 0 ? void 0 : worksite.toUpperCase();
                const allowedWorksites = ["REMOTE", "HYBRID", "ONSITE"];
                const normalizedWorksite = allowedWorksites.includes(worksiteParam)
                    ? worksiteParam
                    : undefined;
    ...
    getCompanyJobs(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { title, category, sortBy = "createdAt", sortOrder = "desc", page = "1", size = "6", } = req.query;
