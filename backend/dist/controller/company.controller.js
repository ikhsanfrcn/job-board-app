...
const passwordChange_1 = require("../services/company/passwordChange");
class CompanyController {
    ...
    verify(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                const result = yield (0, verifyCompany_1.verifyCompanyAccount)((_a = req.user) === null || _a === void 0 ? void 0 : _a.id);
    ...
    getAllCompanies(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                res.status(200).send(Object.assign({ message: "Companies fetched successfully" }, companies));
            }
            catch (error) {
                res
                    .status(error.status || 500)
    ...
    getCompanyDetail(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const company = yield (0, getCompanyDetail_1.getCompanyDetailService)(companyName);
                if (!company) {
