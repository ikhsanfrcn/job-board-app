...
const fromSlug_1 = require("../../helpers/fromSlug");
const prisma_1 = __importDefault(require("../../prisma"));
const getCompanyDetailService = (companyName) => __awaiter(void 0, void 0, void 0, function* () {
    const company = yield prisma_1.default.company.findFirst({
        where: {
            name: {
                equals: (0, fromSlug_1.fromSlug)(companyName),
                mode: "insensitive",
            },
        },
        include: {
