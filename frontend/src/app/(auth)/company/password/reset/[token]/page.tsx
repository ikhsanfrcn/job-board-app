...
import { CompanyResetSchema } from "@/schema/companySchema";
import { ICompanyResetForm } from "@/types/companyType";
...
export default function ResetPasswordPage() {
  ...
  const initialValues: ICompanyResetForm = {
    newPassword: "",
  };

  const onReset = async (
    value: ICompanyResetForm,
      ...
      <div className="relative flex flex-col items-center justify-center w-[480px] rounded-sm mx-auto pb-8 h-fit md:h-full z-10">
        ...
        {resetSuccess ? (
          ...
          <Formik
            ...
            validationSchema={CompanyResetSchema}
            onSubmit={onReset}
          >
            {(props: FormikProps<ICompanyResetForm>) => {
